    ...
    <>
      ...
      >
        <div className="text-center px-6 max-w-lg">
          <p
            aria-hidden="true"
            className="text-6xl font-extrabold text-[#134E5E] mb-2 tracking-tight"
          >
            404
          </p>
          ...
          <a
            href="/"
            className="inline-block bg-[#134E5E] text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-[#E76F51] hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#134E5E] focus-visible:ring-offset-2"
          >
            Return to home
          </a>
        </div>
